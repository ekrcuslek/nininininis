...
<script>
function pop() {
	swal("수정 완료","관리자 페이지로 이동합니다", "success");
...
<body>
	...
	if (count_duplicate > 0) {
		...
		//	out.println(df.format(cal2.getTime())+" "+ "yida2");
			...
			bs.update(new Booking(name, date, room, addr, tel, in_name, comment, write_date, "1"), originDate, originRoom);
			%><script>
				pop();
