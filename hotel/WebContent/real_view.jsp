	...
	<table class="table table-hover" style="width: 1400px; margin: auto">
		...
		if (loginOK == null || !loginOK.equals("yes")) {
			...
			<td align="right"><input type="button"
				onclick="location.href='realgongji_list.jsp'" value="목록"></td></tr> <%
			
			
		} else {
		%>		<td></td>
			<td align="right"><input type="button"
				onclick="location.href='realgongji_list.jsp'" value="목록"><input
				type="submit" value="수정"><input type="button"
				onclick="location.href='real_delete.jsp?nodl=<%=bdList.get(i).getNo()%>'"
				value="삭제"></td></tr> <%
		}
